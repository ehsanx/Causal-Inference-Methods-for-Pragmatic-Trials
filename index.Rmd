...
Below is an overview prepared at the beginning of the project, back in 2018:
...
and a patient partner was recruited for reviewing lay summaries and providing feedback (also acknowledged in the published manuscripts).
...
BC SUPPORT (Support for People and Patient-Oriented Research and Trials) Unit Real World Clinical Trials (RWCT) Methods Cluster Project (RWCT – 002;  [Overview](https://members.bcsupportunit.ca/methods-clusters/webinars)).
```
